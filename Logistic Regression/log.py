...
while converged !=1:
    ...
    for i in range(0,100,1):
        	...
        	#print "new weight of weight vector i=",i," is: ",wt[i]," the value of learning_rate*maxdw is:",learning_rate*maxdw
...
for file_no in range(0,len(allfiles),1):
    ...
    for token in currentDatavectorX:
        indx = indx + 1
        mean = mean + currentDatavectorX[token] * wt[indx]
    if mean < 0:
        correct = correct +1
...
print "the accuracy of logistic regression with ",lamda," lamda value is ",accuracy
